package com.incedo.smartcar.jettyEmbedded;

import com.incedo.smartcar.configuration.SmartCarInitializer;
                ...
                setConfigurations(new org.eclipse.jetty.webapp.Configuration[] {
                        new AnnotationConfiguration() {
                            ...
                            public void configure(WebAppContext context) throws Exception {
                                ...
                                new SmartCarInitializer().onStartup(context.getServletContext());
                            }
                        }
                });
            }
